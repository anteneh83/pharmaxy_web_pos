...
const initialExtensions: VoucherExtensions = {
  lineItemExt1: 'Schedule II - High Control',
  lineItemExt2: '2027-06-15 (Batch #BN-2026-001)',
  voucherExt1: 'CLM-8894102',
  voucherExt2: 'AUTH-99021',
  voucherExt3: 'DEA-AB1234567',
  voucherExt4: 'NPI-1992837465',
  voucherExt5: 'Pharm. S. Chen (#RPH-4402)',
  voucherExt6: 'VER-882190',
  voucherExt7: 'Refills Left: 3 of 5',
...
export const usePOSStore = create<POSStore>((set, get) => ({
  ...
  period: '2026-08',
  remark: 'Standard Pharmacy Transaction',
  organizationUnit: 'Main Store - Counter 1',
  totalQuantity: 5,
  totalValue: 50.55,
  paymentMethod: 'Cash',
  cartCount: 2,
  serialNumber: 'SN-99842',
  fromStore: 'Downtown Main Pharmacy',
  purpose: 'Prescription Fill',
  voucherNote: 'Patient requested generic substitution where available. Insurance verified.',
  lineItemNote: 'Take 1 tablet every 8 hours after food.',
